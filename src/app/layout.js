    ...
    <html lang="en">
      <body className="bg-[#1A0033] text-white font-sans">
        <nav className="bg-black text-white px-6 py-4 flex justify-between items-center shadow-md sticky top-0 z-50 border-b border-pink-500">
          <Link
            href="/"
            className="text-2xl font-extrabold bg-gradient-to-r from-purple-400 via-pink-400 to-fuchsia-500 text-transparent bg-clip-text hover:opacity-80 transition"
          >
            Brain Wave at UCLA
          </Link>
          <div className="space-x-6 text-lg font-medium">
            ...
            <Link href="/affiliates" className="hover:text-pink-300 transition-colors">
              Affiliates
            </Link>
          </div>
        </nav>
