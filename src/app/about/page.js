  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-12 flex flex-col items-center font-sans">
      ...
      <p className="text-xl max-w-2xl text-center text-white mb-12">
        Brainwave at UCLA is a student-run neuroscience organization that fosters collaboration,
        curiosity, and exploration of the brain. We host events, research seminars, and outreach
        programs to connect students with the latest in brain science and neurotechnology.
      </p>

      {/* Founder Profiles */}
      <section className="w-full flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-14 max-w-6xl">
          {[
            {
              name: 'Sharlotta Mozes: Founder',
              img: '/founder.jpg',
              quote:
                'Starting Brainwave has been the most fulfilling experience of my time at UCLA. We’re building a family here.',
            },
            {
              name: 'Noah St. Clair: Co-Founder',
              img: '/cofounder1.jpg',
              quote:
                'This community opened doors I never thought possible — in science and in friendship.',
            },
            {
              name: 'Abhi Singh: Co-Founder',
              img: '/cofounder2.jpg',
              quote:
                'We created Brainwave to bring neuroscience to everyone, not just researchers.',
            },
            {
              name: 'Lily Matolon: Co-Founder',
              img: '/cofounder3.jpg',
              quote:
                'Brainwave lets us connect the science of the brain to the heart of the community.',
            },
